...
from domain import ID, Person, PersonName, Location, PhysicalLocation, WaitingListType, Money
from domain.value_items import FeeSchedule
...
def simple_library(
    ...
    return SimpleLibrary(
        ...
        max_fines_before_suspension=Money(amount=decimal.Decimal(100.0), currency_name="EUR"),
